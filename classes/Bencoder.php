...
class Bencoder
{
    ...
    {
    	self::benc_resp(array("failure reason" => array('type' => "string", 'value' => $msg)));
    	exit;
    }

    public static function benc_resp($d)
    {
    	self::benc_resp_raw(self::benc(array('type' => "dictionary", 'value' => $d)));
    }

    public static function benc_resp_raw($x)
    {
    ...
    public static function benc($obj) 
    {
    ...
    public static function bdec_file($f, $ms) 
    {
        $fp = fopen($f, "rb");
    ...
    public static function bdec($s) 
    {
        ...
        {
            case "l":
                return self::bdec_list($s);
            case "d":
                return self::bdec_dict($s);
            default:
                return;
        }
    }

    public static function bdec_list($s) 
    {
        if ($s[0] != "l")
            return;
    ...
    //
    public static function bdec_dict($s) 
    {
        if ($s[0] != "d")
            return;
